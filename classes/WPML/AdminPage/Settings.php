...
final class WPML_AdminPage_Settings extends WPRun_BaseAbstract_0x5x0
{
    ...
    protected function actionAdminMenu()
    {
        ...
        add_filter('plugin_action_links_' . 'wp-mailto-links/wp-mailto-links.php', array($this, 'plugin_action_links'));
    }

    function plugin_action_links($links) {
      $settings_link = '<a href="' . admin_url('options-general.php?page=wp-mailto-links-option-page') . '" title="Mailto Links Settings">Settings</a>';
